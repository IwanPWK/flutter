...
class Task extends DataClass implements Insertable<Task> {
  ...
  final String title;
  final int userId;
  const Task({required this.id, required this.title, required this.userId});
  @override
  Map<String, Expression> toColumns(bool nullToAbsent) {
    final map = <String, Expression>{};
    map['id'] = Variable<int>(id);
  ...
  Task copyWith({int? id, String? title, int? userId}) => Task(
    id: id ?? this.id,
    ...
    : super(
        TableManagerState(
          ...
          updateCompanionCallback:
              ...
              }) => TasksCompanion(id: id, title: title, userId: userId),
          createCompanionCallback:
              ({
                Value<int> id = const Value.absent(),
                required String title,
                required int userId,
              }) => TasksCompanion.insert(id: id, title: title, userId: userId),
          withReferenceMapper: (p0) => p0
              .map(
                (e) =>
