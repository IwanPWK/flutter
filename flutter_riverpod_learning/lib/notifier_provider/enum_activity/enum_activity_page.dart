...
class _EnumActivityPageState extends ConsumerState<EnumActivityPage> {
  ...
  Widget build(BuildContext context) {
    ref.listen<EnumActivityState>(
      ...
      //  if(previous != null){
      //   print('periksa nilai previous dan next previous = ${previous.activities.first} - next = ${next.activities.first}');  
      //   print('hashCode in listen: ${previous.hashCode}-${next.hashCode}');
      //  } 
